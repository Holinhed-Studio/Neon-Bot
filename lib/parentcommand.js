...
class ParentCommand {
   ...
   load() {
      ...
      try {
         ...
         console.log(colors.format(colors.fg.red),`[CRITICAL] Cannot load commands.\n${err}`);
         return;
      }
   ...
   payload(api, args) {
      ...
      try {
         ...
         console.log(colors.format(colors.fg.red), '[CRITICAL] There was a problem running that command.');
         console.log(err);
      }
